...
const Card3DEnhanced: React.FC<Card3DEnhancedProps> = ({
  children,
  className = '',
  intensity = 15,
  glow = true,
  ...
  return (
    <motion.div
      ...
      whileHover={{ 
        scale: 1.02, 
        zIndex: 10,
        boxShadow: glow ? '0 0 60px rgba(79,158,255,0.3)' : '0 25px 50px -12px rgba(0, 0, 0, 0.25)'
      }}
      transition={{ 
        duration: 0.3, 
        ease: [0.23, 1, 0.32, 1] 
